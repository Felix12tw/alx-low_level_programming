Files that converts binary_to_uint.c is a function that converts a binary number to an unsigned int.
...
File holberton.h is the header file containing all the function prpes of this project.i
